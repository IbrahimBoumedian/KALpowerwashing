...
const navLinks = Array.from(
  document.querySelectorAll("header  .nav-link , header .btns > a")
);
...
// Add active class to nav links on scrolling
const sections = document.querySelectorAll("section");
window.addEventListener("scroll", () => {
  let navLinks = Array.from(document.querySelectorAll("header nav .nav-link"));
  let current = "";
  ...
  navLinks.forEach((li) => {
    ...
    document
      .querySelector("nav .nav-link[href*= " + current + "]")
